...
require (
	...
	github.com/hashicorp/hcp-sdk-go v0.15.1-0.20220112153249-f565607d7cc4 // indirect
	github.com/hashicorp/packer-plugin-sdk v0.2.12-0.20220216103740-f7d4bf877a45 // indirect
